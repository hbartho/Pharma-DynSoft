...
PostgreSQL-only backend (MongoDB removed)
"""
...
from routes.stock_lots import router as stock_lots_router
...
from routes.payment_methods import router as payment_methods_router, payments_router
from routes.debts import router as debts_router
from routes.supplier_debts import router as supplier_debts_router
from routes.shifts import router as shifts_router
from routes.shift_schedules import router as shift_schedules_router
from routes.inventory import router as inventory_router
from routes.pending_sales import router as pending_sales_router
...
app.include_router(stock_lots_router, prefix="/api")
...
app.include_router(supplier_debts_router)
app.include_router(shifts_router, prefix="/api")
app.include_router(shift_schedules_router, prefix="/api")
app.include_router(inventory_router, prefix="/api")
app.include_router(pending_sales_router, prefix="/api")
